...
$.browser ={};
$.browser.mozilla = /firefox/.test(window.navigator.userAgent.toLowerCase());
$.browser.webkit = /webkit/.test(window.navigator.userAgent.toLowerCase());
$.browser.opera = /opera/.test(window.navigator.userAgent.toLowerCase());
$.browser.msie = /msie/.test(window.navigator.userAgent.toLowerCase());
$.browser.msie11 = $.browser.msie && /msie 11\.0/i.test(window.navigator.userAgent.toLowerCase());
