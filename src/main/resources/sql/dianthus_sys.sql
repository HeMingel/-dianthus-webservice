...
MySQL - 5.6.44 : Database - dianthus
*********************************************************************
*/
...
/*Table structure for table `d_sys_dictionary` */
...
('402880e971d0a3980171d0a43a890000','asdfras',NULL,'',2222,'asdfas',NULL,'',0,'2020-05-01 22:29:16',0),
('8a808eb96f401fa2016f401fbe9f0000','系统管理',NULL,'系统管理员',70,NULL,NULL,'/dianthus/images/ico_08.png',1,'2019-12-26 10:53:40',1),
('8a808eb96f40d5e7016f40d601d40000','用户管理',NULL,NULL,10,'/dianthus/sys/user/list','8a808eb96f401fa2016f401fbe9f0000',NULL,NULL,'2019-12-26 14:12:45',1),
('8a808eb96f40d5e7016f40d602250001','角色管理',NULL,NULL,20,'/dianthus/sys/role/list','8a808eb96f401fa2016f401fbe9f0000',NULL,0,'2019-12-26 14:12:45',1),
('8a808eb96f40d5e7016f40d602290002','权限管理',NULL,NULL,30,'/dianthus/sys/menu/list','8a808eb96f401fa2016f401fbe9f0000',NULL,0,'2019-12-26 14:12:45',1),
('8a808ec36dec656c016dec65811d0000','首页',NULL,'',10,'/dianthus/home/index',NULL,'/dianthus/images/ico_01.png',0,'2019-10-21 11:39:01',1),
('8a808ecb6f896168016f8968090c0004','组织管理',NULL,'',40,'/dianthus/sys/org/list','8a808eb96f401fa2016f401fbe9f0000',NULL,NULL,'2020-01-09 16:24:48',1);
...
('402880e971d467590171d46867b00001',NULL,NULL,NULL,NULL,NULL,'2020-05-02 16:02:24',0),
...
('402880e971d3bc600171d3bd438f0000','ROLE_USER','测试用户','','2020-05-02 12:55:28',0),
('402880e971d467590171d468a6ba0002','123','123','123','2020-05-02 16:02:40',0),
...
CREATE TABLE `d_sys_user` (
  ...
  `user_order` int(11) DEFAULT NULL COMMENT '用户排序',
  `user_office_phone` varchar(100) DEFAULT NULL COMMENT '用户座机',
  `user_duty` varchar(100) DEFAULT NULL COMMENT '用户职位',
  `user_position` varchar(100) DEFAULT NULL COMMENT '用户职责',
...
insert  into `d_sys_user`(`id`,`push_id`,`user_name`,`user_login_name`,`user_password`,`user_phone`,`user_mail`,`org_id`,`last_login_time`,`user_order`,`user_office_phone`,`user_duty`,`user_position`,`user_sex`,`create_time`,`enable_flag`) values 
('f07bf386da044ae48fe7bbd08478ceb6',NULL,'全站管理员','admin','$2a$10$puBHZpl2vUzGOVijjUssO.JQOijRVA6GqJDEgnCYCbROIzMMFQ.Ca','15155632675','admin@admin.com','ff143f22cf6d4ca4a672e349caf478dd',NULL,NULL,NULL,NULL,NULL,NULL,'2020-03-17 10:58:47',1);
